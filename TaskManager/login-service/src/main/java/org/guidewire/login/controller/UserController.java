...
public class UserController {
    ...
    @GetMapping("/list/ids")
    public ResponseEntity<List<UserResponse>> getUserById(@RequestBody String[] ids) {
        return ResponseEntity.ok(userService.getUserById(Arrays.stream(ids).map(UUID::fromString).toList()));
    }
